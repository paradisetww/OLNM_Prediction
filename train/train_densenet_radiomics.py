...
from networks.densenet_radiomics import DenseNet121
...
def main():
    ...
    model = DenseNet121(spatial_dims=3, in_channels=1, out_channels=2, num_radiomics_features=args.num_radiomics_features, fused_pattern=args.fused_pattern).cuda(args.gpu)
